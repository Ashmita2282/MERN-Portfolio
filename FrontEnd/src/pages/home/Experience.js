  ...
  return (
    ...
    >
      ...
      <div className="flex py-10 gap-20 sm:flex-col">
        <div className="flex flex-col justify-evenly gap-10 border-l-4 border-[#2ca69862] w-1/3 sm:flex-row sm:overflow-x-scroll sm:w-full sm:border-none">
        ...
        <div className="flex flex-col gap-5 w-2/3 sm:w-full">
          <h1 className="text-secondary text-xl">
            {educations[selectedItemIndex].school}
          </h1>
